...
project = u'DummyProject'
copyright = u'2015, Andreas Kührmann'
...
htmlhelp_basename = 'quaternion-doc'
...
latex_documents = [
  ('index', 'user_guide.tex', u'DummyProject Documentation',
   u'Andreas Kührmann', 'manual'),
]
